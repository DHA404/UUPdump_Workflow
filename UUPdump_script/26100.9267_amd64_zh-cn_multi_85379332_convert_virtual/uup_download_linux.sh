...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=85379332-7c4a-4966-9fa5-4c48a7b934f1&pack=zh-cn&edition=professional%3Bcorecountryspecific%3Bcore&aria2=2"
if [ $? != 0 ]; then
