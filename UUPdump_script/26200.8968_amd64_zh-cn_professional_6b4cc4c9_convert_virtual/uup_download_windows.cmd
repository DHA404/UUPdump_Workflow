@echo off
:: Generated on 2026-07-23 03:52:27 GMT
...
:START_PROCESS
title 26200.8968_amd64_zh-cn_professional_6b4cc4c9 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=6b4cc4c9-525e-4904-9ac2-3cfbc0bce3da&pack=zh-cn&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
