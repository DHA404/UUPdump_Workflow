...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=35630b7b-4509-45b6-83a1-d4c75d5aa9b6&pack=zh-cn&edition=professional%3Bppipro%3Bcorecountryspecific%3Bcore&aria2=2"
if [ $? != 0 ]; then
