...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=312f676b-2cbe-41aa-ba85-85c09c88518c&pack=zh-cn&edition=professional%3Bcorecountryspecific%3Bcore&aria2=2"
if [ $? != 0 ]; then
