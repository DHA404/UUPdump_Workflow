@echo off
:: Generated on 2026-08-25 06:10:00 GMT
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --timeout=30 --max-tries=5 --retry-wait=5 --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=312f676b-2cbe-41aa-ba85-85c09c88518c&pack=neutral&edition=app&aria2=2"
