#!/bin/bash
#Generated on 2026-09-15 02:01:55 GMT
...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=95cc0dd5-949f-452e-9115-30f6c5836016&pack=zh-cn&edition=professional&aria2=2"
if [ $? != 0 ]; then
