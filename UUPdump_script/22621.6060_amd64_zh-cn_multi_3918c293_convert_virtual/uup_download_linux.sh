...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=3918c293-2ddf-43f2-ae3c-a97fc9b9a9c1&pack=zh-cn&edition=professional%3Bcorecountryspecific%3Bcore&aria2=2"
if [ $? != 0 ]; then
