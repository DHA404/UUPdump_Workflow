@echo off
:: Generated on 2026-08-25 06:27:41 GMT
...
:START_PROCESS
title 26200.9267_amd64_zh-cn_multi_fc2fbfd7 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" --timeout=30 --max-tries=5 --retry-wait=5 -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=fc2fbfd7-10b4-480f-967e-9af61f9d48c3&pack=neutral&edition=app&aria2=2"
