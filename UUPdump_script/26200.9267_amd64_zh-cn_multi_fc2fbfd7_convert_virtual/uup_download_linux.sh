...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=fc2fbfd7-10b4-480f-967e-9af61f9d48c3&pack=zh-cn&edition=professional%3Bcorecountryspecific%3Bcore&aria2=2"
if [ $? != 0 ]; then
